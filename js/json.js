...
const url = "https://kizzatronreal.github.io/26S-JavaScript-01-Week11/js/icecream.json";
...
// Create the H1 element
    ...
    para.textContent = `Head Offic: ${json.headOffice} est. ${json.established}, Status: ${json.active ? "active" : "inactive"}`;
